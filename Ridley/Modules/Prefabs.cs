...
namespace Ridley.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = RidleyPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = RidleyPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = RidleyPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = RidleyPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            RidleyPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            RidleyPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            RidleyPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
