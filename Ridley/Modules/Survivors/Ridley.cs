	...
	public static class Ridley
	{
		...
		internal static void CreateCharacter()
		{
			...
			if (value)
			{
				...
				Ridley.CreateSkills();
				Ridley.CreateSkins();
				Ridley.InitializeItemDisplays();
				Ridley.CreateDoppelganger();
			}
		}
		...
		private static void CreateHitboxes()
		{
			...
			hitboxTransform = componentInChildren.FindChild("UpTilt");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "UpTilt");
		...
		private static void CreateSkills()
		{
			...
			string str = "NDP";
			Skills.AddPassiveSkill(Ridley.characterPrefab);
			SkillDef skillDef = Skills.CreateSkillDef(new SkillDefInfo
			{
				skillName = str + "_RIDLEY_BODY_PRIMARY_SLASH_NAME",
				skillNameToken = str + "_RIDLEY_BODY_PRIMARY_SLASH_NAME",
				skillDescriptionToken = str + "_RIDLEY_BODY_PRIMARY_SLASH_DESCRIPTION",
			...
			Skills.AddPrimarySkill(Ridley.characterPrefab, skillDef);
			SkillDef skillDef2 = Skills.CreateSkillDef(new SkillDefInfo
			{
				skillName = str + "_RIDLEY_BODY_SECONDARY_GUN_NAME",
				skillNameToken = str + "_RIDLEY_BODY_SECONDARY_GUN_NAME",
			...
			{
				skillName = str + "_RIDLEY_BODY_UTILITY_ROLL_NAME",
				skillNameToken = str + "_RIDLEY_BODY_UTILITY_ROLL_NAME",
				skillDescriptionToken = str + "_RIDLEY_BODY_UTILITY_ROLL_DESCRIPTION",
			...
			Skills.AddUtilitySkills(Ridley.characterPrefab, new SkillDef[]
			{
				skillDef3
			});
			SkillDef skillDef4 = Skills.CreateSkillDef(new SkillDefInfo
			{
				skillName = str + "_RIDLEY_BODY_SPECIAL_BOMB_NAME",
			...
			Skills.AddSpecialSkills(Ridley.characterPrefab, new SkillDef[]
			{
				skillDef4
			});
		}
		...
		private static void InitializeItemDisplays()
		{
			...
			Ridley.itemDisplayRuleSet = ScriptableObject.CreateInstance<ItemDisplayRuleSet>();
		...
		internal static void SetItemDisplays()
		{
			...
			Ridley.itemDisplayRuleSet.keyAssetRuleGroups = Ridley.itemDisplayRules.ToArray();
		...
		private static CharacterModel.RendererInfo[] SkinRendererInfos(CharacterModel.RendererInfo[] defaultRenderers, Material[] materials)
		{
			...
			array[Ridley.bodyRendererIndex].defaultMaterial = materials[2];
