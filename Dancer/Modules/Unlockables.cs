...
{
    internal static class Unlockables // copied from PaladinMod
    {
        ...
        public static void RegisterUnlockables()
        {
            ...
            //dancerMasterySkinDef = AddUnlockable<Achievements.MasteryAchievement>(true);
            dancerRescueMageDef = AddUnlockable<Achievements.DancerRescueMageAchievement>(true);
